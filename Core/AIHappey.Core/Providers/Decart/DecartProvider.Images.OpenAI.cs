...
public partial class DecartProvider
{
    ...
    {
        throw new NotSupportedException("Decart Lucy Image requires an input image. Use the OpenAI-compatible image edits endpoint.");
    }
    ...
    public async Task<OpenAIImagesResponse> OpenAIImageEditRequestAsync(OpenAIImageEditRequest options, CancellationToken cancellationToken = default)
    {
        ...
        var response = await DecartImageRequest(request, cancellationToken);
