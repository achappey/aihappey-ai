...
public partial class MagisteriumProvider : IModelProvider
{
    ...
    private void ApplyAuthHeader()
    {
        ...
        if (string.IsNullOrWhiteSpace(key))
            throw new InvalidOperationException($"No {nameof(Magisterium)} API key.");
    ...
    public string GetIdentifier() => nameof(Magisterium).ToLowerInvariant();
