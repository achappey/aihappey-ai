...
public partial class SurferCloudProvider : IModelProvider
{
    ...
    public SurferCloudProvider(IApiKeyResolver keyResolver, AsyncCacheHelper asyncCacheHelper,
        IHttpClientFactory httpClientFactory)
    {
        _keyResolver = keyResolver;
        _memoryCache = asyncCacheHelper;
        _client = httpClientFactory.CreateClient();
        _client.BaseAddress = new Uri("https://api.umodelverse.ai/");
    }
    ...
    private void ApplyAuthHeader()
    {
        ...
        if (string.IsNullOrWhiteSpace(key))
            throw new InvalidOperationException($"No {nameof(SurferCloud)} API key.");
    ...
    public string GetIdentifier() => nameof(SurferCloud).ToLowerInvariant();
