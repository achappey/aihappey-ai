...
namespace AIHappey.Core.Providers.LangbasePipe;

public partial class LangbasePipeProvider : IModelProvider
{
    ...
    public LangbasePipeProvider(IApiKeyResolver keyResolver, AsyncCacheHelper asyncCacheHelper,
    ...
    private void ApplyAuthHeader()
    {
        ...
        if (string.IsNullOrWhiteSpace(key))
            throw new InvalidOperationException($"No {nameof(LangbasePipe)} API key.");
    ...
    public string GetIdentifier() => nameof(LangbasePipe).ToLowerInvariant();
