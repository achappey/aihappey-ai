...
public partial class OpperAIProvider : IModelProvider
{
    ...
    public Task<SpeechResponse> SpeechRequest(SpeechRequest request, CancellationToken cancellationToken = default)
        => OpperAISpeechRequest(request, cancellationToken);
    ...
    public Task<ImageResponse> ImageRequest(ImageRequest request, CancellationToken cancellationToken = default)
        => OpperAIImageRequest(request, cancellationToken);
    ...
    public async Task<AIResponse> ExecuteUnifiedAsync(AIRequest request, CancellationToken cancellationToken = default)
    {
        ...
        return IsRoundtableModel(request.Model)
            ? await ExecuteRoundtableUnifiedAsync(request, cancellationToken)
