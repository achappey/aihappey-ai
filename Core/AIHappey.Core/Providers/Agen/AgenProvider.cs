...
public partial class AgenProvider : IModelProvider
{
        ...
        IHttpClientFactory httpClientFactory)
    {
        ...
        _client.BaseAddress = new Uri("https://api.agenhq.com/");
    }
    ...
    private void ApplyAuthHeader()
    {
        ...
        if (string.IsNullOrWhiteSpace(key))
            throw new InvalidOperationException($"No {nameof(Agen)} API key.");
    ...
    public string GetIdentifier() => nameof(Agen).ToLowerInvariant();
