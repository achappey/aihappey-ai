...
public partial class ModelRouterProvider : IModelProvider
{
    ...
    public ModelRouterProvider(IApiKeyResolver keyResolver, AsyncCacheHelper asyncCacheHelper,
    ...
    private void ApplyAuthHeader()
    {
        ...
        if (string.IsNullOrWhiteSpace(key))
            throw new InvalidOperationException($"No {nameof(ModelRouter)} API key.");
    ...
    public string GetIdentifier() => nameof(ModelRouter).ToLowerInvariant();
