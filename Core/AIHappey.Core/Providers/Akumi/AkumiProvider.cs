...
namespace AIHappey.Core.Providers.Akumi;

public partial class AkumiProvider : IModelProvider
{
    ...
    public AkumiProvider(IApiKeyResolver keyResolver, AsyncCacheHelper asyncCacheHelper,
        IHttpClientFactory httpClientFactory)
    {
        _keyResolver = keyResolver;
        _memoryCache = asyncCacheHelper;
        _client = httpClientFactory.CreateClient();
        _client.BaseAddress = new Uri("https://api.akumi.cloud/");
    }
    ...
    private void ApplyAuthHeader()
    {
        ...
        if (string.IsNullOrWhiteSpace(key))
            throw new InvalidOperationException($"No {nameof(Akumi)} API key.");
    ...
    public string GetIdentifier() => nameof(Akumi).ToLowerInvariant();
