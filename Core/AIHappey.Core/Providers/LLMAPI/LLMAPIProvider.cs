...
public partial class LLMAPIProvider : IModelProvider
{
    ...
    private void ApplyAuthHeader()
    {
        ...
        if (string.IsNullOrWhiteSpace(key))
            throw new InvalidOperationException($"No {nameof(LLMAPI)} API key.");
    ...
    public string GetIdentifier() => nameof(LLMAPI).ToLowerInvariant();
