...
namespace AIHappey.Core.Providers.FreeInference;

public partial class FreeInferenceProvider : IModelProvider
{
    ...
    public FreeInferenceProvider(IApiKeyResolver keyResolver, AsyncCacheHelper asyncCacheHelper,
        IHttpClientFactory httpClientFactory)
    {
        _keyResolver = keyResolver;
        _memoryCache = asyncCacheHelper;
        _client = httpClientFactory.CreateClient();
        _client.BaseAddress = new Uri("https://freeinference.org/");
    }
    ...
    private void ApplyAuthHeader()
    {
        ...
        if (string.IsNullOrWhiteSpace(key))
            throw new InvalidOperationException($"No {nameof(FreeInference)} API key.");
    ...
    public string GetIdentifier() => nameof(FreeInference).ToLowerInvariant();
