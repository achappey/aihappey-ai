...
namespace AIHappey.Core.Providers.Picklyone;

public partial class PicklyoneProvider : IModelProvider
{
    ...
    public PicklyoneProvider(IApiKeyResolver keyResolver, AsyncCacheHelper asyncCacheHelper,
        IHttpClientFactory httpClientFactory)
    {
        _keyResolver = keyResolver;
        _memoryCache = asyncCacheHelper;
        _client = httpClientFactory.CreateClient();
        _client.BaseAddress = new Uri("https://api.picklyone.com/");
    }
    ...
    private void ApplyAuthHeader()
    {
        ...
        if (string.IsNullOrWhiteSpace(key))
            throw new InvalidOperationException($"No {nameof(Picklyone)} API key.");
    ...
    public string GetIdentifier() => nameof(Picklyone).ToLowerInvariant();
