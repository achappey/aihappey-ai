...
public partial class WAYSCloudProvider : IModelProvider
{
    ...
    public WAYSCloudProvider(IApiKeyResolver keyResolver, AsyncCacheHelper asyncCacheHelper,
        IHttpClientFactory httpClientFactory)
    {
        _keyResolver = keyResolver;
        _memoryCache = asyncCacheHelper;
        _client = httpClientFactory.CreateClient();
        _client.BaseAddress = new Uri("https://api.wayscloud.services/");
    }
    ...
    public string GetIdentifier() => nameof(WAYSCloud).ToLowerInvariant();
    ...
    public Task<AIResponse> ExecuteUnifiedAsync(AIRequest request, CancellationToken cancellationToken = default)
      => IsChatbotModel(request.Model)
        ? ExecuteChatbotUnifiedAsync(request, cancellationToken)
