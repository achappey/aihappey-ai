...
namespace AIHappey.Core.Providers.Osiris;

public partial class OsirisProvider : IModelProvider
{
    ...
    public OsirisProvider(IApiKeyResolver keyResolver, AsyncCacheHelper asyncCacheHelper,
        IHttpClientFactory httpClientFactory)
    {
        _keyResolver = keyResolver;
        _memoryCache = asyncCacheHelper;
        _client = httpClientFactory.CreateClient();
        _client.BaseAddress = new Uri("https://ai.osiris-code.com/");
    }
    ...
    private void ApplyAuthHeader()
    {
        ...
        if (string.IsNullOrWhiteSpace(key))
            throw new InvalidOperationException($"No {nameof(Osiris)} API key.");
    ...
    public string GetIdentifier() => nameof(Osiris).ToLowerInvariant();
