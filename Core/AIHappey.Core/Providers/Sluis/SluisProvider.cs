...
namespace AIHappey.Core.Providers.Sluis;

public partial class SluisProvider : IModelProvider
{
    ...
    public SluisProvider(IApiKeyResolver keyResolver, AsyncCacheHelper asyncCacheHelper,
        IHttpClientFactory httpClientFactory)
    {
        _keyResolver = keyResolver;
        _memoryCache = asyncCacheHelper;
        _client = httpClientFactory.CreateClient();
        _client.BaseAddress = new Uri("https://api.sluis.ai/");
    }
    ...
    private void ApplyAuthHeader()
    {
        ...
        if (string.IsNullOrWhiteSpace(key))
            throw new InvalidOperationException($"No {nameof(Sluis)} API key.");
    ...
    public string GetIdentifier() => nameof(Sluis).ToLowerInvariant();
