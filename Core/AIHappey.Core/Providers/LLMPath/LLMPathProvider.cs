...
public partial class LLMPathProvider : IModelProvider
{
    ...
    public LLMPathProvider(IApiKeyResolver keyResolver, AsyncCacheHelper asyncCacheHelper,
        IHttpClientFactory httpClientFactory)
    {
        _keyResolver = keyResolver;
        _memoryCache = asyncCacheHelper;
        _client = httpClientFactory.CreateClient();
        _client.BaseAddress = new Uri("https://api.285743.online/");
    }
    ...
    public string GetIdentifier() => "llmpath";
