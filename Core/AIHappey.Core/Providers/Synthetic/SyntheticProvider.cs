...
public partial class SyntheticProvider : IModelProvider
{
    ...
    public SyntheticProvider(IApiKeyResolver keyResolver, AsyncCacheHelper asyncCacheHelper,
    ...
    private void ApplyAuthHeader()
    {
        ...
        if (string.IsNullOrWhiteSpace(key))
            throw new InvalidOperationException($"No {nameof(Synthetic)} API key.");
