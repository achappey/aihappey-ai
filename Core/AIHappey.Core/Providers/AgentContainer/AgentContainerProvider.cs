...
public partial class AgentContainerProvider : IModelProvider
{
    private readonly IApiKeyResolver _keyResolver;
    private readonly AsyncCacheHelper _memoryCache;
    private readonly HttpClient _client;

    public AgentContainerProvider(
        ...
        IHttpClientFactory httpClientFactory)
    {
        ...
        _client.BaseAddress = new Uri("https://agentcontainer.co/api/v1/");
    ...
    private void ApplyAuthHeader(HttpRequestMessage request)
    {
        ...
        if (string.IsNullOrWhiteSpace(key))
            throw new InvalidOperationException("No AgentContainer API key.");

        request.Headers.Authorization = new AuthenticationHeaderValue("Bearer", key);
    }

    public string GetIdentifier() => "agentcontainer";
