...
namespace AIHappey.Core.Providers.Aivara;

public partial class AivaraProvider : IModelProvider
{
    ...
    public string GetIdentifier() => nameof(Aivara).ToLowerInvariant();
