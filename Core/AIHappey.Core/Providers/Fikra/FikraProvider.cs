...
namespace AIHappey.Core.Providers.Fikra;

public partial class FikraProvider : IModelProvider
{
    ...
    public FikraProvider(IApiKeyResolver keyResolver, AsyncCacheHelper asyncCacheHelper,
        IHttpClientFactory httpClientFactory)
    {
        _keyResolver = keyResolver;
        _memoryCache = asyncCacheHelper;
        _client = httpClientFactory.CreateClient();
        _client.BaseAddress = new Uri("https://api.fikraapi.co.ke/");
    }
    ...
    private void ApplyAuthHeader()
    {
        ...
        if (string.IsNullOrWhiteSpace(key))
            throw new InvalidOperationException($"No {nameof(Fikra)} API key.");
    ...
    public string GetIdentifier() => nameof(Fikra).ToLowerInvariant();
