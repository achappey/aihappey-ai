...
public partial class HarnessRouterProvider : IModelProvider
{
    ...
    public HarnessRouterProvider(IApiKeyResolver keyResolver, AsyncCacheHelper asyncCacheHelper,
        IHttpClientFactory httpClientFactory)
    {
        _keyResolver = keyResolver;
        _memoryCache = asyncCacheHelper;
        _client = httpClientFactory.CreateClient();
        _client.BaseAddress = new Uri("https://api.harnessrouter.ai/");
    }
    ...
    public string GetIdentifier() => nameof(HarnessRouter).ToLowerInvariant();
