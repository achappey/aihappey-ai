...
namespace AIHappey.Core.Providers.MIAPI;

public partial class MIAPIProvider : IModelProvider
{
    ...
    public MIAPIProvider(IApiKeyResolver keyResolver,
        IHttpClientFactory httpClientFactory)
    {
        _keyResolver = keyResolver;
        _client = httpClientFactory.CreateClient();
        _client.BaseAddress = new Uri("https://api.miapi.uk/");
    }
    ...
    private void ApplyAuthHeader()
    {
        ...
        if (string.IsNullOrWhiteSpace(key))
            throw new InvalidOperationException($"No {nameof(MIAPI)} API key.");
    ...
    public string GetIdentifier() => nameof(MIAPI).ToLowerInvariant();
