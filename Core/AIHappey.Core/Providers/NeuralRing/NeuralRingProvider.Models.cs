...
public partial class NeuralRingProvider
{
        ...
        return await _memoryCache.GetOrCreateAsync(
            ...
            async ct =>
            {
                ...
                if (!resp.IsSuccessStatusCode)
                {
                    ...
                    throw new Exception($"NeuralRing API error: {err}");
                }
                ...
                foreach (var el in arr)
                {
                    ...
                    if (el.TryGetProperty("slug", out var idEl))
                    {
                    ...
                    if (el.TryGetProperty("pricing", out var pricingEl) &&
                        ...
                        pricingEl.TryGetProperty("unit", out var unitEl) &&
                        unitEl.GetString() == "per_1m_tokens" &&
                        ...
                        outputPerMillion > 0)
                    {
                        ...
                        {
                            // ModelPricing expects the price per token.
