...
public static class UpstageCompletionsMappingExtensions
{
    private static readonly JsonSerializerOptions J = JsonSerializerOptions.Web;

    public static IEnumerable<object> ToUpstageMessages(this IEnumerable<UIMessage> uiMessages)
    {
        foreach (var msg in uiMessages)
        {
            ...
            foreach (var text in msg.Parts.ToUpstageTextParts())
            {
    ...
    private static IEnumerable<string> ToUpstageTextParts(this IEnumerable<UIMessagePart> parts)
    {
    ...
    public static IEnumerable<object> ToUpstageMessages(this IEnumerable<ChatMessage> messages)
    {
        foreach (var msg in messages)
        {
            var role = msg.Role;
            var contentText = msg.Content.ToUpstageContentString();
            ...
            {
                toolCalls = NormalizeToolCallsForUpstageRequest(msg.ToolCalls);
            }
    ...
    public static IEnumerable<object> ToUpstageTools(this IEnumerable<object> tools)
    {
    ...
    public static string ToUpstageContentString(this JsonElement content)
    {
    ...
    private static object NormalizeToolCallsForUpstageRequest(IEnumerable<object> toolCalls)
    {
