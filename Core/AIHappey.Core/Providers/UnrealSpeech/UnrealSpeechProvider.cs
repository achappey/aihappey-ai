...
public partial class UnrealSpeechProvider : IModelProvider, IUnifiedModelProvider
{
    ...
    public UnrealSpeechProvider(IApiKeyResolver keyResolver, IHttpClientFactory httpClientFactory)
    {
        _keyResolver = keyResolver;
        _client = httpClientFactory.CreateClient();
        _client.BaseAddress = new Uri("https://api.v8.unrealspeech.com/");
    }
