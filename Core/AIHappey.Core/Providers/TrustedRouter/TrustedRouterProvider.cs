...
namespace AIHappey.Core.Providers.TrustedRouter;

public partial class TrustedRouterProvider : IModelProvider
{
    ...
    private void ApplyAuthHeader()
    {
        ...
        if (string.IsNullOrWhiteSpace(key))
            throw new InvalidOperationException($"No {nameof(TrustedRouter)} API key.");
    ...
    public string GetIdentifier() => nameof(TrustedRouter).ToLowerInvariant();
