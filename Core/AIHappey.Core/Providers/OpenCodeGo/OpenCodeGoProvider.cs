...
namespace AIHappey.Core.Providers.OpenCodeGo;

public partial class OpenCodeGoProvider : IModelProvider
{
    ...
    public OpenCodeGoProvider(IApiKeyResolver keyResolver,
        ...
        IHttpClientFactory httpClientFactory)
    {
        ...
        _client.BaseAddress = new Uri("https://opencode.ai/zen/go/");
    }
    ...
    private void ApplyAuthHeader()
    {
        ...
        if (string.IsNullOrWhiteSpace(key))
            throw new InvalidOperationException($"No {nameof(OpenCodeGo)} API key.");
    ...
    public string GetIdentifier() => nameof(OpenCodeGo).ToLowerInvariant();
