...
public partial class AgentPhoneProvider
{
        ...
        return await _memoryCache.GetOrCreateAsync(
            ...
            async ct =>
            {
                ...
                if (!resp.IsSuccessStatusCode)
                {
                    ...
                    throw new Exception($"AgentPhone API error: {err}");
                }
                ...
                foreach (var el in arr)
                {
                    ...
                    if (el.TryGetProperty("createdAt", out var createdAtEl) &&
                        createdAtEl.ValueKind == JsonValueKind.String &&
                        DateTimeOffset.TryParse(createdAtEl.GetString(), out var dto))
                    {
