...
public partial class AnLinkAIProvider : IModelProvider
{
    ...
    public AnLinkAIProvider(IApiKeyResolver keyResolver, AsyncCacheHelper asyncCacheHelper,
        IHttpClientFactory httpClientFactory)
    {
        _keyResolver = keyResolver;
        _memoryCache = asyncCacheHelper;
        _client = httpClientFactory.CreateClient();
        _client.BaseAddress = new Uri("https://api.anlinkai.com/api/");
    }
    ...
    private void ApplyAuthHeader()
    {
        ...
        if (string.IsNullOrWhiteSpace(key))
            throw new InvalidOperationException($"No {nameof(AnLinkAI)} API key.");
    ...
    public string GetIdentifier() => nameof(AnLinkAI).ToLowerInvariant();
