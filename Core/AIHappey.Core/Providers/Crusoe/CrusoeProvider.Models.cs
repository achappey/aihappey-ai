...
public partial class CrusoeProvider
{
        ...
        return await _memoryCache.GetOrCreateAsync(
            ...
            async ct =>
            {
                ...
                if (!resp.IsSuccessStatusCode)
                {
                    ...
                    throw new Exception($"Crusoe API error: {err}");
                }
                ...
                foreach (var el in arr)
                {
                        ...
                        pricingEl.ValueKind == JsonValueKind.Object)
                    {
                        ...
                        var inputCacheReadPrice = pricingEl.TryGetProperty("input_cache_reads", out var cacheReadEl)
                            ...
                            completion > 0)
                        {
                            ...
                            {
                                Input = prompt / 1_000_000m,
                                Output = completion / 1_000_000m,
                                InputCacheRead =
                                    decimal.TryParse(
                                        inputCacheReadPrice,
                                        NumberStyles.Any,
