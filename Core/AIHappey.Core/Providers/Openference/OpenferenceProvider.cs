...
namespace AIHappey.Core.Providers.Openference;

public partial class OpenferenceProvider : IModelProvider
{
    ...
    public OpenferenceProvider(IApiKeyResolver keyResolver, AsyncCacheHelper asyncCacheHelper,
        IHttpClientFactory httpClientFactory)
    {
        _keyResolver = keyResolver;
        _memoryCache = asyncCacheHelper;
        _client = httpClientFactory.CreateClient();
        _client.BaseAddress = new Uri("https://api.openference.com/");
    }
    ...
    private void ApplyAuthHeader()
    {
        ...
        if (string.IsNullOrWhiteSpace(key))
            throw new InvalidOperationException($"No {nameof(Openference)} API key.");
    ...
    public string GetIdentifier() => nameof(Openference).ToLowerInvariant();
