...
public partial class OpenferenceProvider
{
        ...
        return await _memoryCache.GetOrCreateAsync(
            ...
            async ct =>
            {
                ...
                if (!resp.IsSuccessStatusCode)
                {
                    ...
                    throw new Exception($"Openference API error: {err}");
                }
           ...
           pricingEl.ValueKind == JsonValueKind.Object)
                    {
                        ...
                        var cacheReadPrice = pricingEl.TryGetProperty("cache_read", out var cacheEl) &&
                                             decimal.TryParse(
                                                 cacheEl.GetString(),
                                                 NumberStyles.Any,
                                                 CultureInfo.InvariantCulture,
