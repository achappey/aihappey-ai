...
public partial class SandBaseProvider : IModelProvider
{
        ...
        IHttpClientFactory httpClientFactory)
    {
        ...
        _client.BaseAddress = new Uri("https://api.sandbase.ai/");
        _mediaClient = httpClientFactory.CreateClient("sandbase-media-downloads");
    }
    ...
    private void ApplyAuthHeader()
    {
        ...
        if (string.IsNullOrWhiteSpace(key))
            throw new InvalidOperationException($"No {nameof(SandBase)} API key.");
    ...
    public string GetIdentifier() => nameof(SandBase).ToLowerInvariant();
