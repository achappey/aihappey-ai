...
namespace AIHappey.Core.Providers.Cline;

public partial class ClineProvider : IModelProvider
{
    ...
    private void ApplyAuthHeader()
    {
        ...
        if (string.IsNullOrWhiteSpace(key))
            throw new InvalidOperationException($"No {nameof(Cline)} API key.");
    ...
    public string GetIdentifier() => nameof(Cline).ToLowerInvariant();
