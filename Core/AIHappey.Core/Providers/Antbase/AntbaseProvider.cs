...
namespace AIHappey.Core.Providers.Antbase;

public partial class AntbaseProvider : IModelProvider
{
    ...
    public AntbaseProvider(IApiKeyResolver keyResolver, AsyncCacheHelper asyncCacheHelper,
        IHttpClientFactory httpClientFactory)
    {
        _keyResolver = keyResolver;
        _memoryCache = asyncCacheHelper;
        _client = httpClientFactory.CreateClient();
        _client.BaseAddress = new Uri("https://antbase.ai/");
    }
    ...
    private void ApplyAuthHeader()
    {
        ...
        if (string.IsNullOrWhiteSpace(key))
            throw new InvalidOperationException($"No {nameof(Antbase)} API key.");
    ...
    public string GetIdentifier() => nameof(Antbase).ToLowerInvariant();
