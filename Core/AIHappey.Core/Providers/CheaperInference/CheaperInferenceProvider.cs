...
public partial class CheaperInferenceProvider : IModelProvider
{
    ...
    public CheaperInferenceProvider(IApiKeyResolver keyResolver, AsyncCacheHelper asyncCacheHelper,
        IHttpClientFactory httpClientFactory)
    {
        _keyResolver = keyResolver;
        _memoryCache = asyncCacheHelper;
        _client = httpClientFactory.CreateClient();
        _client.BaseAddress = new Uri("https://api.cheaperinference.com/");
    }
    ...
    private void ApplyAuthHeader()
    {
        ...
        if (string.IsNullOrWhiteSpace(key))
            throw new InvalidOperationException($"No {nameof(CheaperInference)} API key.");
    ...
    public string GetIdentifier() => nameof(CheaperInference).ToLowerInvariant();
