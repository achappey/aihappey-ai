...
public partial class DarkbloomProvider : IModelProvider
{
    ...
    public DarkbloomProvider(IApiKeyResolver keyResolver, AsyncCacheHelper asyncCacheHelper,
        IHttpClientFactory httpClientFactory)
    {
        _keyResolver = keyResolver;
        _memoryCache = asyncCacheHelper;
        _client = httpClientFactory.CreateClient();
        _client.BaseAddress = new Uri("https://api.darkbloom.dev/");
    }
    ...
    private void ApplyAuthHeader()
    {
        ...
        if (string.IsNullOrWhiteSpace(key))
            throw new InvalidOperationException($"No {nameof(Darkbloom)} API key.");
    ...
    public string GetIdentifier() => nameof(Darkbloom).ToLowerInvariant();
