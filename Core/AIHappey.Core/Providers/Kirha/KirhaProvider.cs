...
public partial class KirhaProvider : IModelProvider
{
        ...
        IHttpClientFactory httpClientFactory)
    {
        ...
        _client.BaseAddress = new Uri("https://api.kirha.ai/chat/");
    }
    ...
    {
        ApplyAuthHeader();
        return await CompleteKirhaChatAsync(options, cancellationToken);
    }

    public IAsyncEnumerable<ChatCompletionUpdate> CompleteChatStreamingAsync(ChatCompletionOptions options, CancellationToken cancellationToken = default)
    {
        ApplyAuthHeader();
        return CompleteKirhaChatStreamingAsync(options, cancellationToken);
    }
    ...
    {
        ApplyAuthHeader();
        return CompleteKirhaResponsesAsync(options, cancellationToken);
    }

    public IAsyncEnumerable<Responses.Streaming.ResponseStreamPart> ResponsesStreamingAsync(Responses.ResponseRequest options, CancellationToken cancellationToken = default)
    {
        ApplyAuthHeader();
        return CompleteKirhaResponsesStreamingAsync(options, cancellationToken);
    }
