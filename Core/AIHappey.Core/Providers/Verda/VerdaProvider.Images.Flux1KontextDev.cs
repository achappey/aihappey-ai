    ...
    : IModelProvider
{
    ...
    public async Task<ImageResponse> Flux1KontextDevImageRequest(ImageRequest imageRequest, CancellationToken cancellationToken = default)
    {
        ApplyAuthHeader();
