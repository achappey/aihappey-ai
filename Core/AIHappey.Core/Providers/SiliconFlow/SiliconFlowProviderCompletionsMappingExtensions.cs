...
public static class SiliconFlowCompletionsMappingExtensions
{
    private static readonly JsonSerializerOptions J = JsonSerializerOptions.Web;

    public static IEnumerable<object> ToSiliconFlowMessages(this IEnumerable<UIMessage> uiMessages)
    {
        foreach (var msg in uiMessages)
        {
            ...
            foreach (var text in msg.Parts.ToSiliconFlowTextParts())
            {
    ...
    private static IEnumerable<string> ToSiliconFlowTextParts(this IEnumerable<UIMessagePart> parts)
    {
    ...
    public static IEnumerable<object> ToSiliconFlowMessages(this IEnumerable<ChatMessage> messages)
    {
        foreach (var msg in messages)
        {
            var role = msg.Role;
            var contentText = msg.Content.ToSiliconFlowContentString();
            ...
            {
                toolCalls = NormalizeToolCallsForSiliconFlowRequest(msg.ToolCalls);
            }
    ...
    public static IEnumerable<object> ToSiliconFlowTools(this IEnumerable<object> tools)
    {
    ...
    public static string ToSiliconFlowContentString(this JsonElement content)
    {
    ...
    private static object NormalizeToolCallsForSiliconFlowRequest(IEnumerable<object> toolCalls)
    {
