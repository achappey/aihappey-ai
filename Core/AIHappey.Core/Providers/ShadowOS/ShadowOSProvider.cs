...
public partial class ShadowOSProvider : IModelProvider
{
        ...
        IHttpClientFactory httpClientFactory)
    {
        ...
        _client.BaseAddress = new Uri("https://shadow-os-backend.onrender.com/api/");
    }
    ...
    private void ApplyAuthHeader()
    {
        ...
        if (string.IsNullOrWhiteSpace(key))
            throw new InvalidOperationException($"No {nameof(ShadowOS)} API key.");
    ...
    public string GetIdentifier() => nameof(ShadowOS).ToLowerInvariant();
