...
public partial class ToolRelayProvider : IModelProvider
{
        ...
        IHttpClientFactory httpClientFactory)
    {
        ...
        _client.BaseAddress = new Uri("https://toolrelay.dev/");
    }
    ...
    private void ApplyAuthHeader()
    {
        ...
        if (string.IsNullOrWhiteSpace(key))
            throw new InvalidOperationException("No ToolRelay API key.");
    ...
    public string GetIdentifier() => "toolrelay";
