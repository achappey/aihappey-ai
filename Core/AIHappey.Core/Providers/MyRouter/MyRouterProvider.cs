...
namespace AIHappey.Core.Providers.MyRouter;

public partial class MyRouterProvider : IModelProvider
{
    ...
    public MyRouterProvider(IApiKeyResolver keyResolver, AsyncCacheHelper asyncCacheHelper,
        IHttpClientFactory httpClientFactory)
    {
        _keyResolver = keyResolver;
        _memoryCache = asyncCacheHelper;
        _client = httpClientFactory.CreateClient();
        _client.BaseAddress = new Uri("https://api.myrouter.ai/");
    }
    ...
    private void ApplyAuthHeader()
    {
        ...
        if (string.IsNullOrWhiteSpace(key))
            throw new InvalidOperationException($"No {nameof(MyRouter)} API key.");
    ...
    public string GetIdentifier() => nameof(MyRouter).ToLowerInvariant();
