...
public partial class WisdomGateProvider : IModelProvider
{
    ...
    public WisdomGateProvider(IApiKeyResolver keyResolver, IHttpClientFactory httpClientFactory)
    {
        ...
        _client.BaseAddress = new Uri("https://wisdom-gate.juheapi.com/");
    }
    ...
    public async Task<CreateMessageResult> SamplingAsync(CreateMessageRequestParams chatRequest, CancellationToken cancellationToken = default)
    {
        ...
        switch (model?.Type)
        {
            ...
            case "video":
                throw new NotSupportedException("WisdomGate video sampling is not supported in MCP sampling mode.");
    ...
    public Task<ImageResponse> ImageRequest(ImageRequest request, CancellationToken cancellationToken = default)
        => WisdomGateImageRequest(request, cancellationToken);

    public Task<VideoResponse> VideoRequest(VideoRequest request, CancellationToken cancellationToken = default)
        => WisdomGateVideoRequest(request, cancellationToken);
