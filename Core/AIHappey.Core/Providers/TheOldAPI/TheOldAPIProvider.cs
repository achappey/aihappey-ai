...
public partial class TheOldAPIProvider : IModelProvider
{
    ...
    public TheOldAPIProvider(IApiKeyResolver keyResolver, AsyncCacheHelper asyncCacheHelper,
        IHttpClientFactory httpClientFactory)
    {
        _keyResolver = keyResolver;
        _memoryCache = asyncCacheHelper;
        _client = httpClientFactory.CreateClient();
        _client.BaseAddress = new Uri("https://theoldllm.com/");
    }
    ...
    private void ApplyAuthHeader()
    {
        ...
        if (string.IsNullOrWhiteSpace(key))
            throw new InvalidOperationException($"No {nameof(TheOldAPI)} API key.");
    ...
    public string GetIdentifier() => nameof(TheOldAPI).ToLowerInvariant();
