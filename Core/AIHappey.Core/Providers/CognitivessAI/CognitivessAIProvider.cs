...
public partial class CognitivessAIProvider : IModelProvider
{
    ...
    public CognitivessAIProvider(IApiKeyResolver keyResolver, AsyncCacheHelper asyncCacheHelper,
        IHttpClientFactory httpClientFactory)
    {
        _keyResolver = keyResolver;
        _memoryCache = asyncCacheHelper;
        _client = httpClientFactory.CreateClient();
        _client.BaseAddress = new Uri("https://api.cognitivess.com/");
    }
    ...
    private void ApplyAuthHeader()
    {
        ...
        if (string.IsNullOrWhiteSpace(key))
            throw new InvalidOperationException($"No {nameof(CognitivessAI)} API key.");
    ...
    public string GetIdentifier() => nameof(CognitivessAI).ToLowerInvariant();
