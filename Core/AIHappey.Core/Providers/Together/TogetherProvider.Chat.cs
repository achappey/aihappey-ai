...
public partial class TogetherProvider : IModelProvider
{
        ...
        [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
        ...
        var togetherMessages = chatRequest.Messages.ToTogetherMessages();
        var metadata = chatRequest.GetProviderMetadata<TogetherProviderMetadata>(GetIdentifier());
        ...
        if (!resp.IsSuccessStatusCode)
        {
            ...
            yield return $"Together API error: {err}".ToErrorUIPart();
        }
