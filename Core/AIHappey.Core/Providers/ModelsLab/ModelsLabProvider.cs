...
public partial class ModelsLabProvider : IModelProvider
{
    ...
    public ModelsLabProvider(IApiKeyResolver keyResolver, AsyncCacheHelper asyncCacheHelper,
        IHttpClientFactory httpClientFactory)
    {
        _keyResolver = keyResolver;
        _memoryCache = asyncCacheHelper;
        _client = httpClientFactory.CreateClient();
        _client.BaseAddress = new Uri("https://modelslab.com/");
    }
    ...
    public async Task<ChatCompletion> CompleteChatAsync(ChatCompletionOptions options, CancellationToken cancellationToken = default)
    {
        ...
        return await this.GetChatCompletion(_client,
             options,
             relativeUrl: "api/v7/llm/chat/completions",
    ...
    public Task<SpeechResponse> SpeechRequest(SpeechRequest imageRequest, CancellationToken cancellationToken = default)
        => SpeechRequestTextToAudio(imageRequest, cancellationToken);
    ...
    public Task<ImageResponse> ImageRequest(ImageRequest request, CancellationToken cancellationToken = default)
        => ImageRequestTextToImage(request, cancellationToken);

    public Task<VideoResponse> VideoRequest(VideoRequest request, CancellationToken cancellationToken = default)
        => VideoRequestTextToVideo(request, cancellationToken);
         ...
         CancellationToken cancellationToken = default)
    {
        ...
        return await this.GetMessage(_client,
            request,
            relativeUrl: "api/v7/llm/v1/messages",
            headers: headers,
            cancellationToken: cancellationToken);
    }
