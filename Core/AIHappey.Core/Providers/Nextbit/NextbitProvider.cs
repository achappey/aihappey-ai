...
public partial class NextbitProvider : IModelProvider
{
    ...
    private void ApplyAuthHeader()
    {
        ...
        if (string.IsNullOrWhiteSpace(key))
            throw new InvalidOperationException($"No {nameof(Nextbit)} API key.");
    ...
    public string GetIdentifier() => nameof(Nextbit).ToLowerInvariant();
