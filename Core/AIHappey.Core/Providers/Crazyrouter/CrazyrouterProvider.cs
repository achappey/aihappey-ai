...
public partial class CrazyrouterProvider : IModelProvider
{
    ...
    public CrazyrouterProvider(IApiKeyResolver keyResolver, AsyncCacheHelper asyncCacheHelper,
    ...
    private void ApplyAuthHeader()
    {
        ...
        if (string.IsNullOrWhiteSpace(key))
            throw new InvalidOperationException($"No {nameof(Crazyrouter)} API key.");
    ...
    public string GetIdentifier() => nameof(Crazyrouter).ToLowerInvariant();
    ...
    public Task<ImageResponse> ImageRequest(ImageRequest request, CancellationToken cancellationToken = default)
        => CrazyrouterImageRequestAsync(request, cancellationToken);
    ...
    {
        throw new NotSupportedException("Crazyrouter does not document a stable OpenAI Images API route for reference-image editing.");
    }
