        ...
        return await _memoryCache.GetOrCreateAsync(
            ...
            async ct =>
            {
                ...
                if (!resp.IsSuccessStatusCode)
                {
                    ...
                    throw new Exception($"Impossibl API error: {err}");
                }
                ...
                foreach (var el in arr)
                {
                    ...
                    if (el.TryGetProperty("pricing", out var pricingEl) &&
                        ...
                        pricingEl.TryGetProperty("input_per_mtok_usd", out var inputEl) &&
                        pricingEl.TryGetProperty("output_per_mtok_usd", out var outputEl) &&
                        ...
                        outputPerMillion > 0)
                    {
                        model.Pricing = new ModelPricing
                        {
                            ...
                            InputCacheRead = pricingEl.TryGetProperty("cached_input_per_mtok_usd", out var cachedInputEl) &&
                                             cachedInputEl.TryGetDecimal(out var cachedInputPerMillion) &&
                                             cachedInputPerMillion > 0
                                ? cachedInputPerMillion / 1_000_000m
                                : null
                        };
                    }
