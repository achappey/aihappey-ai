...
public partial class AICCProvider : IModelProvider
{
    ...
    private void ApplyAuthHeader()
    {
        ...
        if (string.IsNullOrWhiteSpace(key))
            throw new InvalidOperationException($"No {nameof(AICC)} API key.");
    ...
    public string GetIdentifier() => nameof(AICC).ToLowerInvariant();
    ...
    public Task<ImageResponse> ImageRequest(ImageRequest request, CancellationToken cancellationToken = default)
        => ImageRequestAICC(request, cancellationToken);
