...
public partial class LumaAIProvider : IModelProvider
{
    ...
    public LumaAIProvider(IApiKeyResolver keyResolver, IHttpClientFactory httpClientFactory)
    {
        ...
        _client.BaseAddress = new Uri("https://api.lumalabs.ai/");
    }
    ...
    private void ApplyAuthHeader()
    {
        ...
        if (string.IsNullOrWhiteSpace(key))
            throw new InvalidOperationException($"No {nameof(LumaAI)} API key.");
    ...
    public string GetIdentifier() => nameof(LumaAI).ToLowerInvariant();
