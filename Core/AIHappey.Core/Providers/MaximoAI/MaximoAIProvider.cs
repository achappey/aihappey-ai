...
namespace AIHappey.Core.Providers.MaximoAI;

public partial class MaximoAIProvider : IModelProvider
{
    ...
    public MaximoAIProvider(IApiKeyResolver keyResolver, AsyncCacheHelper asyncCacheHelper,
        IHttpClientFactory httpClientFactory)
    {
        _keyResolver = keyResolver;
        _memoryCache = asyncCacheHelper;
        _client = httpClientFactory.CreateClient();
        _client.BaseAddress = new Uri("https://api.maximoai.co/");
    }
    ...
    public string GetIdentifier() => "maximoai";
