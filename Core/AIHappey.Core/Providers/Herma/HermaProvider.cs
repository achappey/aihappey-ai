...
namespace AIHappey.Core.Providers.Herma;

public partial class HermaProvider : IModelProvider
{
        ...
        IHttpClientFactory httpClientFactory)
    {
        ...
        _client.BaseAddress = new Uri("https://herma.up.railway.app/");
    }
    ...
    private void ApplyAuthHeader()
    {
        ...
        if (string.IsNullOrWhiteSpace(key))
            throw new InvalidOperationException($"No {nameof(Herma)} API key.");
