...
public partial class ClodProvider : IModelProvider
{
    ...
    private void ApplyAuthHeader()
    {
        ...
        if (string.IsNullOrWhiteSpace(key))
            throw new InvalidOperationException($"No {nameof(Clod)} API key.");
    ...
    public string GetIdentifier() => nameof(Clod).ToLowerInvariant();
