...
namespace AIHappey.Core.Providers.UncensoredChat;

public partial class UncensoredChatProvider : IModelProvider
{
    ...
    private void ApplyAuthHeader()
    {
        ...
        if (string.IsNullOrWhiteSpace(key))
            throw new InvalidOperationException($"No {nameof(UncensoredChat)} API key.");
    ...
    public string GetIdentifier() => nameof(UncensoredChat).ToLowerInvariant();
