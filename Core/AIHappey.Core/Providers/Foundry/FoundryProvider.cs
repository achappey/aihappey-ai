...
public partial class FoundryProvider : IModelProvider
{
    ...
    public FoundryProvider(IApiKeyResolver keyResolver,
        IOptions<FoundryProviderOptions> options,
        ...
        IHttpClientFactory httpClientFactory)
    {
        ...
        _client.BaseAddress = new Uri($"https://{_endpoint}.services.ai.azure.com/");
    }
    ...
    private void ApplyAuthHeader()
    {
        ...
        if (string.IsNullOrWhiteSpace(key))
            throw new InvalidOperationException($"No {nameof(Foundry)} API key.");
    ...
    public string GetIdentifier() => nameof(Foundry).ToLowerInvariant();
